...
const FocusHistory = () => {
  ...
  return (
    <AppShell>
      ...
      <div className="rounded-2xl p-4 mb-5 bg-gradient-to-br from-primary/[0.05] to-transparent card-glow">
        ...
        {!isLoading && !isError && chartData.length === 0 && <p className="text-muted-foreground text-xs text-center py-8">No data yet.</p>}
        {chartData.length > 0 && (
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={chartData} margin={{ top: 5, right: 5, bottom: 0, left: -20 }}>
              ...
              <Area type="monotone" dataKey="score" stroke="#6C5DD3" strokeWidth={2.5} fill="url(#scoreGrad)" />
            </AreaChart>
          </ResponsiveContainer>
        )}
      </div>
